...
def main():
    ...
    An option may be to remove these activities or to keep them in the log.
    ...
    If the dataframe has been changed, Save the updated dataframe, as ./Pizza_Case_CSV_blind_I6.csv
    """
    ...
    try:
        ...
        output_file_path = "./Pizza_Case_CSV_blind_I6.csv"
