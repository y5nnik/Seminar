...
# Mistake: change a random activity name
# 185,1,123,36,56,Calzone,Large,1,Deliveruu Inc.,Munich District One,Adult,1561,29.01.18 20:03,Payment customer,B ->
#185,1,123,36,56,Calzone,Large,1,Deliveruu Inc.,Munich District One,Adult,1561,29.01.18 20:03,Departure pizza,B
...
def main():
    # 1. Load the raw data
    file_path = "./Pizza_Case_CSV_I15.csv"
    ...
    question = """
    Can you spot the quality issue "Incorrect Activity Names" in the given dataframe df?
    This quality issue corresponds to the scenario where the activity names of events are logged incorrectly.
    in this case, the activity name of the last event in the case 185, should be Payment customer
    ...
    If the dataframe has been changed, Save the updated dataframe, as ./Pizza_Case_CSV_informed_I15.csv
    """
    ...
    try:
        ...
        output_file_path = "./Pizza_Case_CSV_informed_I15.csv"
