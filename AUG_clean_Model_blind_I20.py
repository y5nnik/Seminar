...
def main():
    ...
    For example, assume that each case belongs to a patient and that for each patient the age is only given in terms of ten years.
    ...
    If the dataframe has been changed, Save the updated dataframe, as ./Pizza_Case_CSV_blind_I20.csv
    """
    ...
    try:
        ...
        output_file_path = "./Pizza_Case_CSV_blind_I20.csv"
