...
def main():
    ...
    In this case look for typos in the Pizza Type column
    ...
    If the dataframe has been changed, Save the updated dataframe, as ./Pizza_Case_CSV_informed_I18.csv
    """
    ...
    try:
        ...
        output_file_path = "./Pizza_Case_CSV_informed_I18.csv"
