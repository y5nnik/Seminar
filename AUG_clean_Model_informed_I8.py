...
# Mistake: Delete a random customer ID
...
def main():
    # 1. Load the raw data
    file_path = "./Pizza_Case_CSV_I8.csv"
    ...
    question = """
    Can you spot the quality issue "Missing Resources" in the given dataframe df?
    This quality issue corresponds to the scenario where the resources that executed an activity have not been recorded. 
    For example, the customer of a case is missing.
    ...
    If the dataframe has been changed, Save the updated dataframe, as ./Pizza_Case_CSV_informed_I8.csv
    """
    ...
    try:
        ...
        output_file_path = "./Pizza_Case_CSV_informed_I8.csv"
