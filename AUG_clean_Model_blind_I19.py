...
def main():
    # 1. Load the raw data
    file_path = "./Pizza_Case_CSV_I19.csv"
    ...
    question = """
    Can you spot the quality issue "Imprecise Relationships" in the given dataframe df?
    This quality issue refers to the scenario in which due to the chosen deﬁnition of a case, it is not possible anymore to correlate events in the log to another case type.
    ...
    If the dataframe has been changed, Save the updated dataframe, as ./Pizza_Case_CSV_blind_I19.csv
    """
    ...
    try:
        ...
        output_file_path = "./Pizza_Case_CSV_blind_I19.csv"
