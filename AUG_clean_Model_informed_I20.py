...
def main():
    # 1. Load the raw data
    file_path = "./Pizza_Case_CSV_I20.csv"
    ...
    question = """
    Can you spot the quality issue "Imprecise Case Attributes" in the given dataframe df?
    This quality issue refers to the scenario in which for a case attribute it is not possible to properly use its value as the provided value is too coarse. 
    For example, assume that each case belongs to a customer and each customer represents a certain revenue value, which has been rounded to coarse.
    ...
    If the dataframe has been changed, Save the updated dataframe, as ./Pizza_Case_CSV_informed_I20.csv
    """
    ...
    try:
        ...
        output_file_path = "./Pizza_Case_CSV_informed_I20.csv"
